...
export const coffeeProducts = [
    ...
    story: "Sourced from smallholder farms in the Gedeo Zone, Yirgacheffe beans are carefully processed and sun-dried under traditional methods.",
    farm_images: [
      "/images/yirga2.jpg",
      "/images/yirga1.jpg"
    ]
  },
  {
    ...
    description: "Processed for a fruit-forward cup with balanced body and sweet acidity.",
    size_options: ["250g", "500g", "1kg"],
    brewing_methods: ["French Press", "Cold Brew", "Moka Pot"],
    story: "From highland farms in Sidama, this coffee showcases berry tones and wine-like complexity through careful processing.",
    farm_images: [
      "/images/sidamo2.jpg",
      "/images/sidamo3.jpg"
    ]
  ...
  },
  {
    ...
    description: "Bold with wine-like body and mocha undertones, Harrar coffees are full of intensity.",
    size_options: ["250g", "500g", "1kg"],
  ...
  },
  {
    ...
    harvest: "October–December",
    certifications: ["Specialty", "Conventional"],
    flavor_profile: ["Citrus", "Black Tea", "Floral", "Winey"],
    roast_level: "Medium-Light",
    price: 21.99,
    image: "/images/limu1.jpg",
    description: "Bright citrus acidity and floral complexity define this Limu coffee with a winey note.",
    size_options: ["250g", "500g", "1kg"],
    brewing_methods: ["Pour Over", "AeroPress", "Siphon"],
    story: "Collected from farms near Jimma, Limu is known for refined acidity and aromatic elegance.",
   farm_images: [
      "/images/limu2.avif",
      "/images/limu3.webp"
    ]
  },
  {
    ...
    certifications: ["Specialty", "Conventional"],
    flavor_profile: ["Nutty", "Spice", "Cocoa", "Fruity"],
    roast_level: "Medium",
    price: 17.49,
    image: "/images/lekempti1.jpg",
    description: "Nutty and spicy with fruity acidity, Lekempti offers a well-rounded cup with gentle complexity.",
    size_options: ["250g", "500g", "1kg"],
    brewing_methods: ["French Press", "Drip", "Pour Over"],
    story: "Harvested in East Wollega and sun-dried, this coffee showcases the region’s balanced, fruity tones.",
    farm_images: [
  ...
  },
  {
    ...
    harvest: "November–January",
    certifications: ["Specialty", "Conventional"],
    flavor_profile: ["Fruity", "Sweet", "Herbal", "Balanced"],
    roast_level: "Medium",
    price: 18.99,
    image: "/images/gimbi1.jpg",
    description: "Full-bodied with sweet, fruity notes and a clean finish, Gimbi is a classic washed Ethiopian profile.",
    size_options: ["250g", "500g", "1kg"],
  ...
  },
  {
    id: 11,
    name: "Andrecha",
    origin: "Majenger Zone, Gambela Region",
    grade: "Grade 2",
    process: "Natural",
  ...
  },
  {
    ...
    harvest: "October–January",
    certifications: ["Conventional"],
    flavor_profile: ["Spice", "Herbal", "Mild Fruit"],
    roast_level: "Medium-Dark",
    price: 16.99,
    image: "/images/djimmah1.jpg",
    description: "A staple in traditional blends with subtle spice and weighty mouthfeel.",
    size_options: ["250g", "500g", "1kg"],
